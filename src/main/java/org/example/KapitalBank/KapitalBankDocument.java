package org.example.KapitalBank;
...
public class KapitalBankDocument {
    ...
    public static void processDocument(String[] values) throws IOException {
        ...
        if (!fileDataList.isEmpty()) {
            byte[] fileData = fileDataList.get(7);
            XWPFDocument doc = new XWPFDocument(new ByteArrayInputStream(fileData));
            List<String> allowedWords = SQLiteConnectionExample.KapitalBank1();
